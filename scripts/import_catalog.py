...
Цены и старые цены скрипт выбрасывает: в боте их быть не должно.
А вот ссылку на страницу товара переносит — под карточкой из неё
получается кнопка «Купить на сайте».
...
#
#  Цен в файле нет и быть не должно — их показывает сайт, не бот.
#  url — страница товара, из неё под карточкой делается кнопка «Купить
#  на сайте». Убрал ссылку — кнопка пропала.
#
